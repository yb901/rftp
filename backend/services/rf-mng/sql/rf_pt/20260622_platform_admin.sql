...
INSERT IGNORE INTO `tb_admin` (`username`, `real_name`, `password`, `otp_secret`, `enabled`, `role`)
VALUES (
  'admin',
  '超级管理员',
  '6PcpWndef9MtNADsE6ubT3:U6wN34PHmv07xhjsXQzgCoD2oCUwexIrMbwBPAFQOx9',
  'S1_ILErcId6I3fjyTvdRGntEunIcNj2WzwMN8MiuSLxtYBlLkYQjBAHowYyIxQqSYMTUeDVMxGQe2PWYpo0aIExmv',
  1,
  1
);
