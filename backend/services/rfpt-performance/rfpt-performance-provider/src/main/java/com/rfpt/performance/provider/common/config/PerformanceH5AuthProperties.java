package com.rfpt.performance.provider.common.config;
...
@Data
@Component
@ConfigurationProperties(prefix = "rfpt.performance.h5.auth")
public class PerformanceH5AuthProperties {

    /**
     * 登录 Cookie 名称。
     */
    private String cookieName = "RFPT_PERFORMANCE_MOBILE";
